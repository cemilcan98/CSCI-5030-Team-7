...
file = open("irish_dictionary_filtered.txt", "w", encoding = "UTF-16")
file.write("%s\n" % (irish_dictionary))
file.close()
...
file = open("gram_irish_dictionary_3a_filtered.txt", "w", encoding = "UTF-16")
...
file = open("gram_irish_frequency_filtered_3a.txt", "w", encoding = "UTF-16")
file.write("%s\n" % (gram_frequency_dict_3a))
file.close()


file = open("irish_dictionary_filtered.txt", "r", encoding = "UTF-16")
corpus2 = file.read()
irish_dictionary = ast.literal_eval(corpus2)
file.close()

total = 0
for key in irish_dictionary:
    total += irish_dictionary[key]

frequency_dict = {}
for key in irish_dictionary:
    frequency_dict[key] = irish_dictionary[key]/total

file = open("irish_frequency_filtered.txt", "w", encoding = "UTF-16")
file.write("%s\n" % (frequency_dict))
file.close()
